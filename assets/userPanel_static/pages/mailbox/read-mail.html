        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">حسن شفیعی
</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="mailbox.html"><i class="fa fa-inbox"></i> اینباکس
                ...
                <li><a href="#"><i class="fa fa-trash-o"></i> زباله دان</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="fa fa-circle-o text-light-blue"></i> شبکه ها اجتماعی</a></li>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
